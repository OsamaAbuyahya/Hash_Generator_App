...
import os.abuyahya.hashgeneratorapp.databinding.FragmentSuccessBinding

class SuccessFrag : Fragment() {

    private val args: SuccessFragArgs by navArgs()
    ...
    override fun onCreateView(
        ...
        binding.hashTxt.text = args.hashData
    ...
    private suspend fun applyAnimation(){
        ...
        binding.include.messageTxt.animate().translationY(80f).duration = 200L
        delay(2000L)

        binding.include.messageBg.animate().translationY(-80f).duration = 500L
        binding.include.messageTxt.animate().translationY(-80f).duration = 500L
    }
